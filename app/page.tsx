    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[600px] flex items-center justify-center text-white">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">Authentic West African Jollof Rice</h1>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">About The Jollof Guys</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground">Only the finest spices and freshest ingredients in every dish</p>
              </CardContent>
            </Card>
      ...
      <section className="py-16 bg-orange-50">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">Taste the authentic flavors of West Africa</p>
          </div>
            ...
            <Card>
              ...
              <CardContent className="p-6">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-xl font-semibold">Classic Jollof Rice</h3>
      ...
      <section className="py-16">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Find Us at NYC Markets</h2>
            <p className="text-lg text-muted-foreground">Visit us at these popular NYC locations</p>
          </div>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">Queens Night Market</h3>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  <MapPin className="w-6 h-6 text-orange-600 mt-1" />
                  <div>
                    <h3 className="text-xl font-semibold mb-2">Uptown Night Market</h3>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  <MapPin className="w-6 h-6 text-orange-600 mt-1" />
                  <div>
                    <h3 className="text-xl font-semibold mb-2">Bronx Night Market</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="p-6">
                ...
                <div className="font-semibold">- Adaora K.</div>
              </CardContent>
            </Card>
      ...
      <section className="py-16 bg-orange-600 text-white">
        <div className="container mx-auto max-w-4xl px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Experience Authentic Jollof?</h2>
          <p className="text-xl mb-8">Book us for your next event or visit us at one of our market locations</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              variant="outline"
